      ...
      <div style={{ paddingTop: "40px" }}>
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <img
              style={{ borderRadius: "20px", height: "300px", width: "100%" }}
          ...
          <Grid item xs={12} md={6}>
            <TableContainer>
              <Table className={classes.table} aria-label="customized table">
                <TableBody>
                  ...
                  <StyledTableRow>
                    <StyledTableCell>Recipe Servings</StyledTableCell>
                    <StyledTableCell align="right">
                  ...
                  <StyledTableRow>
                    <StyledTableCell>Total Cook Time</StyledTableCell>
                    <StyledTableCell align="right">
            ...
            <div style={{ paddingTop: "40px" }}>
              <Typography variant={"h5"}>Related Recipes</Typography>
